		...
		success: function(response){
			...
			for(let i = 0;i < response.length;i++){
				...
				if (response[i]["fields"]['activado'] == false) {
					fila += '<td class="fila-table"><a href="#" class="link" style="background:#a30707; color:#fff;border-radius:3px;padding-left:5px;padding-right:5px" onclick="abrir_modal_detalles(\'/perfil_admin/reserva_detalles_plato/'+response[i]['pk']+'/\');">Caducado</a></td>';
				}else if (response[i]["fields"]['activado'] == true){
					if (response[i]["fields"]['confirmar'] == true) {
						fila += '<td class="fila-table"><a href="#" class="link" style="background:#00A40E; color:#fff;border-radius:3px;padding-left:5px;padding-right:5px" onclick="abrir_modal_detalles(\'/perfil_admin/reserva_detalles_plato/'+response[i]['pk']+'/\');">Aceptado</a></td>';
					}else{
						fila += '<td class="fila-table"><a href="#" class="link" style="background:#d47108; color:#fff;border-radius:3px;padding-left:5px;padding-right:5px" onclick="abrir_modal_detalles(\'/perfil_admin/reserva_detalles_plato/'+response[i]['pk']+'/\');">Cancelado</a></td>';
					}
				}
