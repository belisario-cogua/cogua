		...
		success: function(response){
			...
			for(let i = 0;i < response.length;i++){
				...
				if (response[i]["fields"]['imagen']){
					fila += '<td class="text-center fila-table"><a href="#" class="link" onclick="abrir_modal_detalles(\'/perfil_admin/detalles_usuario/'+response[i]['pk']+'/\');"><img style="width:30px;" src="/media/'+ response[i]["fields"]['imagen']+'"/></a></td>';
				}else{
